...
def main():
    ...
    print('Approve')
    print(erc1.approve(tswp, 100, {'from': accounts[3]})) # Approve purchase of SaaS Coin
    ...
    print('Swap')
    print(tswp.swapTokens(1, accounts[3], 100, {'from': accounts[1]}).events); # SAAS owner swaps User's VUSD for SAAS
