...
from brownie import Diamond, DiamondCut, ERC20Token, MockOracle, TokenSwap, accounts, interface
...
def main():
    ...
    print('Diamond 1 (whoDAI): {}'.format(dm1))
    ...
    print('Diamond 2 (vtUSD): {}'.format(dm2))
    ...
    print('Diamond 3 (ATLX): {}'.format(dm3))
    ...
    print('Diamond 4 (Swap): {}'.format(dm4))
